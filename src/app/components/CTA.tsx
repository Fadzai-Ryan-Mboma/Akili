        ...
        >
          ...
          <div className="relative text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link to="/playground" className="group relative px-8 py-4 rounded-full bg-gradient-to-r from-orange-500 to-purple-600 text-white font-semibold text-lg overflow-hidden">
              ...
              <Link to="/pricing" className="px-8 py-4 rounded-full border border-white/30 text-white font-semibold text-lg hover:bg-white/5 backdrop-blur-sm transition-all">
                View Pricing
              </Link>
            </div>
